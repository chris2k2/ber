...
async function start_crawler(start_year, start_month, type) {
    ...
    await crawler.full_overview("https://www.turnier.de/find/" + type + "?StartDate=" + start + "&EndDate=" + enddate + "&page=10000")
