...
let tournament = {};
tournament.id = "/site/liga/liga/17/18/24211";
tournament.name = "Bayernliga Nord";
...
const crawl = Consumer.create({
    ...
    handleMessage: (message, done) => {
        ...
        if (msgObject.source == "turnierde") {
            start.crawler(startDate.getFullYear(), startDate.getMonth()).then(x => console.log("CRAWLER: " + x));
